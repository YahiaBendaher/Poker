...
| 15 | Deux Paires battent une Paire | Elyes | M1=[5,5,8,8,2], M2=[14,14,10,9,4] -> "Main 1 gagne" | F | | | |
| 16 | Comparer deux "Deux Paires" sur la paire la plus élevée | Amacine | M1=[10,10,8,8,4], M2=[9,9,7,7,13] -> "Main 1 gagne" | F | | | |
| 17 | Comparer deux "Deux Paires" sur la deuxième paire | Yahia | M1=[10,10,8,8,4], M2=[10,10,7,7,13] -> "Main 1 gagne" | F | | | |
| 18 | Comparer deux "Deux Paires" sur le kicker | Rafia | M1=[10,10,8,8,13], M2=[10,10,8,8,4] -> "Main 1 gagne" | F | | | |
| **Phase 4 : Introduction progressive du Brelan** | | | | | | | |
| 19 | Détecter un brelan dans une main de 3 cartes | Elyes | Entrée : [7, 7, 7] -> Sortie : "Brelan de 7" | F | | | |
| 20 | Détecter un brelan dans une main de 5 cartes | Amacine | Entrée : [7, 7, 7, 2, 9] -> Sortie : "Brelan de 7" | F | | | |
| 21 | Un Brelan bat Deux Paires | Yahia | M1=[4,4,4,2,3], M2=[14,14,13,13,10] -> "Main 1 gagne" | F | | | |
| 22 | Comparer deux Brelans de valeurs différentes | Rafia | M1=[7,7,7,2,3], M2=[5,5,5,12,10] -> "Main 1 gagne" | F | | | |
| **Phase 5 : Introduction progressive de la Suite** | | | | | | | |
| 23 | Détecter si 3 valeurs sont consécutives | Elyes | Entrée : [5, 6, 7] -> Sortie : "Consécutives" | F | | | |
...
| 43 | Détecter un Full (contient un Brelan ET une Paire) | Amacine | Entrée : ["5Pi", "5Co", "5Tr", "8Ca", "8Co"] -> Sortie : "Full" | F | | | |
| 44 | Un Full bat une Couleur | Yahia | M1=["5Pi", ...] (Full), M2=["2Pi", ...] (Couleur) -> "Main 1 gagne" | F | | | |
| 45 | Comparer deux Fulls sur la valeur du Brelan | Rafia | M1=[5,5,5,8,8], M2=[4,4,4,14,14] -> "Main 1 gagne" | F | | | |
| **Phase 9 : Introduction progressive du Carré** | | | | | | | |
| 46 | Détecter un Carré (4 cartes identiques) | Elyes | Entrée : ["7Pi", "7Co", "7Tr", "7Ca", "2Co"] -> Sortie : "Carré" | F | | | |
| 47 | Un Carré bat un Full | Amacine | M1=["7Pi", ...] (Carré), M2=["APi", ...] (Full) -> "Main 1 gagne" | F | | | |
| 48 | Comparer deux Carrés de valeurs différentes | Yahia | M1=[8,8,8,8,2], M2=[7,7,7,7,14] -> "Main 1 gagne" | F | | | |
| **Phase 10 : Introduction progressive de la Quinte Flush** | | | | | | | |
| 49 | Vérifier si une main est une Suite | Rafia | (Réutiliser la logique de la slice 38) Entrée : ["5Pi", "6Pi", "7Pi", "8Pi", "9Pi"] -> Sortie : "Est une Suite" | F | | | |
| 50 | Vérifier si une main est une Couleur | Elyes | (Réutiliser la logique de la slice 41) Entrée : ["5Pi", "6Pi", "7Pi", "8Pi", "9Pi"] -> Sortie : "Est une Couleur" | F | | | |
| 51 | Détecter une Quinte Flush (est une Suite ET une Couleur) | Amacine | Entrée : ["5Pi", "6Pi", "7Pi", "8Pi", "9Pi"] -> Sortie : "Quinte Flush" | PF | | | |
| 52 | Une Quinte Flush bat un Carré | Yahia | M1=["5Pi", ...] (Quinte Flush), M2=["ACo", ...] (Carré) -> "Main 1 gagne" | F | | | |
| 53 | Comparer deux Quinte Flush sur la carte la plus haute | Rafia | M1=["6Pi", ..., "10Pi"], M2=["5Co", ..., "9Co"] -> "Main 1 gagne" | F | | | |
| 54 | Détecter une Quinte Flush Royale (Quinte Flush à l'As) | Toute l'équipe | Entrée : ["10Pi", "VPi", "DPi", "RPi", "APi"] -> Sortie : "Quinte Flush Royale" | F | | | |
| **Phase 11 : Interaction Utilisateur et Finalisation** | | | | | | | |
| 55 | [Affichage] Afficher le nom de la combinaison de la main gagnante | Yahia | M1=[5,5,2,3,4], M2=[14,12,9,6,8] -> "Main 1 gagne avec : Paire de 5" | F | | | |
| 56 | [Interaction] Demander à l'utilisateur de saisir la Main 1 | Rafia | Affiche "Entrez la Main 1 : " et lit l'entrée utilisateur. | F | | | |
| 57 | [Interaction] Demander à l'utilisateur de saisir la Main 2 | Elyes | Affiche "Entrez la Main 2 : " et lit l'entrée utilisateur. | F | | | |
| 58 | [Affichage] Afficher le résultat final de façon claire | Amacine | Affiche : "Main 1: [2Pi...APi] (Couleur) bat Main 2: [5Tr...9Tr] (Suite)" | F | | | |
| 59 | [Interaction] Créer une boucle pour rejouer | Toute l'équipe | Après un résultat, demande "Comparer d'autres mains ? (o/n)". | PF | | | |